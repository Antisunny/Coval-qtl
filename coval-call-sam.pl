...
if ($maximum_read_depth == 0){
    ...
    close (FILE);
    my $ave_read_depth = int ($read_num / $ref_size * 10) / 10;
    $maximum_read_depth = $ave_read_depth * 3;
    print STDERR "Average read depth: $ave_read_depth\n";
    print STDERR "Maximum read depth specified: $maximum_read_depth\n";
}
